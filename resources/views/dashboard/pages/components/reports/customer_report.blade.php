...
<body>
<div class="container">
    <a href="{{ route('customer_report.index') }}" class="btn btn-primary mt-3">Back</a>
    ...
    <div class="filter-container">
        <form method="GET" action="{{ route('customer_report.index') }}" class="row g-3 align-items-end">
            ...
            <div class="col-12">
                <a href="{{ route('customer_report.pdf') }}" class="btn btn-success">Export PDF</a>
            </div>
        </form>
    </div>
            ...
            <table class="table table-striped table-bordered">
                ...
                @foreach($customers as $customer)
                    <tr>
                        ...
                        <td>
                            <a href="{{ route('customer_report.details', ['customer_id' => $customer->customer_id]) }}"
