...
@section('content')
    <div class="card mx-auto" style="max-width: 750px;">
        <div class="card-header d-flex justify-content-between align-items-center py-3 bg-light">
            <h4 class="mb-0 fw-semibold">{{ isset($unit) ? 'Edit Unit' : 'Create New Unit' }}</h4>
            <a href="{{ route('units.index') }}" class="btn btn-sm btn-outline-dark">
        ...
        <div class="card-body p-4">
            <form action="{{ isset($unit) ? route('units.update', $unit->id) : route('units.store') }}"
                ...
                <div class="row g-3">
                    <!-- Name Field -->
                    <div class="col-md-8">
                        <label for="name" class="form-label fw-medium">Unit Name <span class="text-danger">*</span></label>
                    ...
                    <div class="col-md-4">
                        ...
                        <div class="form-check form-switch">
                            ...
                            <input type="checkbox" class="form-check-input" id="status" name="status" value="1"
                                {{ (old('status', $unit->status ?? true)) ? 'checked' : '' }}>
                    ...
                    <div class="col-12">
                        ...
                        <textarea class="form-control @error('description') is-invalid @enderror"
                                  ...
                                  data-next="submitBtn">{{ old('description', $unit->description ?? '') }}</textarea>
                        @error('description')
                        <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
